...
* MERGE TO FILE OF SCHOOLS AND COMPETITORS WITHIN 30 MILE RADIUS; 
...
* NOW MERGE ON COMPETITORS THAT BELONG TO ANALYSIS SAMPLE (2-YEAR SCHOOLS); 	
	...
	save scrap_rad30, replace; 
	erase scrap.dta; erase scrap_insample.dta; 
	
restore;

* LOOP THROUGH SANCTION YEARS AND CREATE MEASURE OF NUMBER OF SANCTIONED COMPETITORS WITHIN RADIUS (ALL CATEGORIES) IN EACH SY;	
forv y = 1991/2000 {;
...
preserve;
	...
	merge 1:m opeid_matched using scrap_rad30, update; keep if _m >=3 | nocomp == 1; drop _m; 
	gen sanct_year = `y'; 
...
foreach g of num 2(2)6 {;
	...
	gen `v'`g'_rs_r30 = recipients_l1 if group == `g' & `v' == 1;
	recode `v'`g'_rs_r30 (. = 0); 
}; 
...
foreach t of var tech health beauty comp_bus cul_art mech_eng {;
	...
	gen `v'_`t'_r30 = `v' if group == 6 & `t' == 1; 
	recode `v'_`t'_r30 (. = 0); 
...
foreach t of var tech health beauty comp_bus cul_art mech_eng {;
	...
	gen `v'_`t'_rs_r30 = r(recipients_l1*`v') if group == 6 & `t' == 1; 
	recode `v'_`t'_rs_r30 (. = 0); 
...
gen anysanc_num_schain_r30 = chain_id_1 == chain_id_matched & chain_id_1 ~=. ; 

gen pub = group == 2; gen np = group == 4; gen fp = group == 6; 

collapse (max) anysanc_ll2_r30 = sanc_ll2_r30 anysanc_ll4_r30 = sanc_ll4_r30 anysanc_ll6_r30 = sanc_ll6_r30  
				anysanc_lp2_r30 = sanc_lp2_r30 anysanc_lp4_r30 = sanc_lp4_r30 anysanc_lp6_r30 = sanc_lp6_r30  
				anysanc2_r30 anysanc4_r30 anysanc6_r30 
				anysuphld2_r30  anysuphld4_r30 anysuphld6_r30 
		(sum)  numsanc_ll2_r30 = sanc_ll2_r30 numsanc_ll4_r30 = sanc_ll4_r30 numsanc_ll6_r30 = sanc_ll6_r30  
				numsanc_lp2_r30 = sanc_lp2_r30 numsanc_lp4_r30 = sanc_lp4_r30 numsanc_lp6_r30 = sanc_lp6_r30  
				numsanc2_r30 = anysanc2_r30 numsanc4_r30 = anysanc4_r30 numsanc6_r30 = anysanc6_r30 
				numsuphld2_r30 = anysuphld2_r30  numsuphld4_r30 = anysuphld4_r30 numsuphld6_r30 = anysuphld6_r30 
				numsanc_tech_r30 = anysanc_tech_r30 numsanc_health_r30 = anysanc_health_r30 numsanc_beauty_r30 = anysanc_beauty_r30
				numsanc_comp_bus_r30 = anysanc_comp_bus_r30 numsanc_cul_art_r30 = anysanc_cul_art_r30 numsanc_mech_eng_r30 = anysanc_mech_eng_r30
				anysanc_ll_rs2_r30 = sanc_ll2_rs_r30 anysanc_ll_rs4_r30 = sanc_ll4_rs_r30 anysanc_ll_rs6_r30 = sanc_ll6_rs_r30  
				anysanc_lp_rs2_r30 = sanc_lp2_rs_r30 anysanc_lp_rs4_r30 = sanc_lp4_rs_r30 anysanc_lp_rs6_r30 = sanc_lp6_rs_r30  
				anysanc_rs2_r30 = anysanc2_rs_r30 anysanc_rs4_r30 = anysanc4_rs_r30 anysanc_rs6_r30 = anysanc6_rs_r30 
				anysanc_tech_rs_r30 anysanc_health_rs_r30 anysanc_beauty_rs_r30 anysanc_comp_bus_rs_r30 
				anysanc_cul_art_rs_r30 anysanc_mech_eng_rs_r30
				num2_r30 = pub num4_r30 = np num6_r30 = fp
				numsanc_schain_r30 = anysanc_num_schain_r30, 
				by(opeid_1 sanct_year); 
				
				
	save scrap_r30_`y', replace; 
...
forv y = 1992/2000 {;
	...
	append using scrap_r30_`y'; 
	
};

save scrap_stacked_r30, replace; 

forv y = 1991/2000 {;

	erase scrap_r30_`y'.dta; 
	
};

* DROP UNNECESSARY VARS;
drop stabbr count county fips_alt name2 ;
...
foreach v of var sanc_ll sanc_lp sanc anysuphld *_r30 {;
...
save "${intermediate}/stacked_data_2yearinsts_r30", replace;

erase scrap_stacked_r30.dta;
erase scrap_rad30.dta;
