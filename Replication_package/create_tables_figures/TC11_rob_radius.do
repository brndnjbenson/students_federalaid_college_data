/* CREATES OUTPUT USED IN ONLINE APPENDIX TABLE C11: ROBUSTNESS OF THE IMPACT OF SANCTIONS ON PELL GRANT RECIPIENT ENROLLMENT: ALTERNATIVE MARKET DEFINITIONS */
...
************ MARKET = SCHOOLS WITHIN 15 MILE RADIUS **************;
use "${intermediate}/stacked_data_2yearinsts_r15", clear; 

* OPTION TO DROP COUNTIES WITH MORE THAN 50 SCHOOLS (WITH PELL RECIPIENTS) PER YEAR, ON AVERAGE;
destring fips, replace; 
gen ind = inlist(fips,4013, 6037, 6059, 6073, 12025, 17031, 26163, 36061, 42003, 42101, 48113, 48201, 36005, 36047, 36081, 36085);
...
forv i = 1/9 {;
	...
	bysort opeid t (sanct_year): gen priornum`i'= numsanc6_r15[_n-`i'] if opeid == opeid[_n-`i'] & t == t[_n-`i'] & sanct_year == sanct_year[_n-`i']+`i';
	recode priornum`i' (. = 0);
};
...
forv i = 2(2)6 {;
	replace num`i'_r15 = num`i'_r15 +1 if group ==`i';
	gen number_unsanc_fips`i' = num`i'_r15 - numsanc`i'_r15;
};

foreach v of var anysanc_rs2_r15 anysanc_rs4_r15 anysanc_rs6_r15 {; replace `v' = 0 if sanc==1; replace `v' = ln(`v'+1); };

* INTERACT TREATMENTXPOST WITH SECTOR INDICATORS;
foreach v of var sanc anysanc_rs2_r15 anysanc_rs4_r15 anysanc_rs6_r15  {;
...
* (1) SCHOOLS FROM ALL COUNTIES;
xi: reghdfe lnrecips_2  i.post|G2sanc i.post|G4sanc i.post|G6sanc 
	i.post|G2anysanc_rs2_r15 i.post|G4anysanc_rs2_r15  i.post|G6anysanc_rs2_r15  
	i.post|G2anysanc_rs4_r15  i.post|G4anysanc_rs4_r15   i.post|G6anysanc_rs4_r15   
	i.post|G2anysanc_rs6_r15   i.post|G4anysanc_rs6_r15   i.post|G6anysanc_rs6_r15  if abs(t)<=8, a(syid t year group##c.t fips##c.t) cl(opeid );
...
forv j = 2(2)6 {;
	...
	sum recipients  if t == -1  &  numsanc`i'_r15 >0 & group == `j'; loc m`j'_`i' = r(mean);
	sum number_unsanc_fips`j' if t == -1 & numsanc`i'_r15 >0 ; loc n`j'_`i' = r(mean);
...
outreg2 using "${output}/TC11_rob_radius.txt", keep(_I*) replace dec(3) sym(**,*,+) se aster(se) 
...
* (2) EXCLUDE SCHOOLS FROM "LARGE" COUNTIES;
drop if ind == 1; 
xi: reghdfe lnrecips_2  i.post|G2sanc i.post|G4sanc i.post|G6sanc 
	i.post|G2anysanc_rs2_r15 i.post|G4anysanc_rs2_r15  i.post|G6anysanc_rs2_r15  
	i.post|G2anysanc_rs4_r15  i.post|G4anysanc_rs4_r15   i.post|G6anysanc_rs4_r15   
...
outreg2 using "${output}/TC11_rob_radius.txt", keep(_I*) ap dec(3) sym(**,*,+) se aster(se) 
	addstat("pval - sanc", `p_sanc', "pval - comp spub",`p_comp2',"pval - comp snp",`p_comp4',"pval - comp sfp",`p_comp6',
	"pval - public comp", `p_pcomp',"pval - np comp", `p_npcomp', "pval - fp comp", `p_fpcomp',
	"mean - sp", `m_sanc2', "mean - snp", `m_sanc4', "mean - sfp", `m_sanc6', 
	"mean - pc_sp",`m2_2', "mean - npc_sp",`m4_2', "mean - fpc_sp",`m6_2',
...
************ MARKET = SCHOOLS WITHIN 30 MILE RADIUS **************;
use "${intermediate}/stacked_data_2yearinsts_r30", clear; 
...
forv i = 1/9 {;
	...
	bysort opeid t (sanct_year): gen priornum`i'= numsanc6_r30[_n-`i'] if opeid == opeid[_n-`i'] & t == t[_n-`i'] & sanct_year == sanct_year[_n-`i']+`i';
	recode priornum`i' (. = 0);
};
...
forv i = 2(2)6 {;
	replace num`i'_r30 = num`i'_r30 +1 if group ==`i';
	gen number_unsanc_fips`i' = num`i'_r30 - numsanc`i'_r30;
};

foreach v of var anysanc_rs2_r30 anysanc_rs4_r30 anysanc_rs6_r30 {; replace `v' = 0 if sanc==1; replace `v' = ln(`v'+1); };

* INTERACT TREATMENTXPOST WITH SECTOR INDICATORS;
foreach v of var sanc anysanc_rs2_r30 anysanc_rs4_r30 anysanc_rs6_r30 {;
foreach n of num 2(2)6 {;
	capture drop G`n'`v'; 
	gen G`n'`v' = `v' if group == `n'; recode G`n'`v' (. = 0); 
};
...
* (3) SCHOOLS FROM ALL COUNTIES;
xi: reghdfe lnrecips_2  i.post|G2sanc i.post|G4sanc i.post|G6sanc 
	i.post|G2anysanc_rs2_r30 i.post|G4anysanc_rs2_r30  i.post|G6anysanc_rs2_r30  
	i.post|G2anysanc_rs4_r30  i.post|G4anysanc_rs4_r30   i.post|G6anysanc_rs4_r30   
	i.post|G2anysanc_rs6_r30   i.post|G4anysanc_rs6_r30   i.post|G6anysanc_rs6_r30  if abs(t)<=8, a(syid t year group##c.t fips##c.t) cl(opeid );
...
forv j = 2(2)6 {;
	...
	sum recipients  if t == -1  &  numsanc`i'_r30 >0 & group == `j'; loc m`j'_`i' = r(mean);
	sum number_unsanc_fips`j' if t == -1 & numsanc`i'_r30 >0 ; loc n`j'_`i' = r(mean);
...
* (4) EXCLUDE SCHOOLS FROM "LARGE" COUNTIES;
drop if ind == 1; 
xi: reghdfe lnrecips_2  i.post|G2sanc i.post|G4sanc i.post|G6sanc 
	i.post|G2anysanc_rs2_r30 i.post|G4anysanc_rs2_r30  i.post|G6anysanc_rs2_r30  
	i.post|G2anysanc_rs4_r30  i.post|G4anysanc_rs4_r30   i.post|G6anysanc_rs4_r30   
