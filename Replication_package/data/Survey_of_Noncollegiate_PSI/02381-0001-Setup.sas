*-------------------------------------------------------------------------*
|                                                                         |
|              SAS DATA DEFINITION STATEMENTS FOR ICPSR 2381              |
|       POSTSECONDARY CAREER SCHOOL SURVEY, 1977-78: [UNITED STATES]      |
|                        1ST ICPSR VERSION                                |
|                         November, 2001                                  |
|                                                                         |
|                                                                         |
...
| needs. PROC FORMAT  and  FORMAT  sections have been marked by SAS       |
| comment statements. To include these sections in a final SAS setup,     |
| users should remove the SAS comment statements from the desired         |
| section(s).                                                             |
*-------------------------------------------------------------------------;
* SAS PROC FORMAT;                                                         
/*                                                                         
